defmodule TinyEVM do
  ...
  """
  @spec execute(address :: String.t(), gas :: integer, code :: binary) ::
  ...
  def execute(context) do
    cond do
      ...
      context.execution_state == :stop or
          context.program_counter >= byte_size(context.machine_code) ->
        %ExecutionContext{
          # Process refund on success
          gas_remaining: context.gas_remaining - context.gas_refund,
          # Leaving this in for visibility on the refund applied
